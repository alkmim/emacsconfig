...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (realgud sphinx-doc company-quickhelp openwith company-jedi company pcap-mode multi-term flycheck helm markdown-mode magit git-gutter material-theme org elpy better-defaults))))
(custom-set-faces
